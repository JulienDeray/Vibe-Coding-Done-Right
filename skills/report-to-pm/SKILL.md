...
Check if there are uncommitted changes and commit them before proceeding.
...
- Use the `/commit` skill to create a commit with the changes
- Wait for the commit to complete before proceeding

**If no uncommitted changes:**
- Skip this step and proceed to fetching the Notion page
...
### Step 6: Compose Implementation Notes
...
**7a. Add Implementation Notes section:**
...
**7b. Check acceptance criteria boxes:**
